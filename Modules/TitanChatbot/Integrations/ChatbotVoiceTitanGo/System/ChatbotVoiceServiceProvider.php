...
// Titan Go IO endpoints (additive). Titan Go is internal-only and requires auth.
$router->post('api/v2/chatbot-voice/{uuid}/go/input', [TitanGoController::class, 'input'])
    ->name('chatbot-voice.go.input');
$router->post('api/v2/chatbot-voice/{uuid}/go/end', [TitanGoController::class, 'end'])
    ->name('chatbot-voice.go.end');
